var app = getApp();
var p = 1;
var parallelList = function (that) {
  app.clientFetch(app.globalData.hostUrl + '/parallel_shops?page='+p+'&per_page=10',
    'GET',
    function (res) {
      var l = that.data.parallel;
      for (var i = 0; i < res.data.data.length; i++) {
        l.push(res.data.data[i])
      }
      that.setData({
        parallel: l,
        totalPage : res.data.meta.page
      });
      p++;
    },
    function (res) {
